				...
				<label for="edit-menu-item-icon-<?php echo $item_id; ?>">
					...
					<div class="dem-field dem-field_media <?php echo $attachment ? 'dem-field_value' : 'dem-field_empty'; ?>">
						<?php printf('<input %s />', implode(' ', array_filter(array(
							sprintf('%s="%s"', 'class', 'dem-field__input edit-menu-item-icon'),
							sprintf('%s="edit-dem-menu-item-icon-%s"', 'id', $item_id),
							sprintf('%s="dem-menu-item-icon[%s]"', 'name', $item_id),
							sprintf('%s="%s"', 'type', 'hidden'),
							sprintf('%s="%s"', 'value', esc_attr($icon))
						)))); ?>
						<span class="dem-field__value">
                            <img class="dem-field__value__img" src="<?php echo $attachment ? $attachment['src'] : ''; ?>" alt="item <?php echo $item_id; ?> icon" />
                        </span>
						...
						<span class="description dem-field__description"><?php _e('The icon will be displayed in the menu if the current theme supports it.', 'dem'); ?></span>
					</div>
				</label>
			</p>
