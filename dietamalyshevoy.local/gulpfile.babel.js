...
const DIRECTORIES = {
    js: {
        src: 'wp-content/themes/dietamalyshevoy/js/src/**/*.js',
        build: 'wp-content/themes/dietamalyshevoy/js/build/'
    },
    scss: {
        src: 'wp-content/themes/dietamalyshevoy/scss/**/*.scss',
        build: 'wp-content/themes/dietamalyshevoy/css/src/'
    },
    css: {
        src: 'wp-content/themes/dietamalyshevoy/css/src/**/*.css',
        build: 'wp-content/themes/dietamalyshevoy/css/build/'
    }
};
