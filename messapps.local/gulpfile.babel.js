...
const DIRECTORIES = {
    js: {
        src: 'wp-content/themes/messapps/js/src/**/*.js',
        build: 'wp-content/themes/messapps/js/build/'
    },
    scss: {
        src: 'wp-content/themes/messapps/scss/**/*.scss',
        build: 'wp-content/themes/messapps/css/src/'
    },
    css: {
        src: 'wp-content/themes/messapps/css/src/**/*.css',
        build: 'wp-content/themes/messapps/css/build/'
    }
};
