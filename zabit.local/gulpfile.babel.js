...
const DIRECTORIES = {
    js: {
        src: `wp-content/themes/${process.env.THEME_NAME}/js/src/**/*.js`,
        build: `wp-content/themes/${process.env.THEME_NAME}/js/build/`
    },
    scss: {
        src: `wp-content/themes/${process.env.THEME_NAME}/scss/**/*.scss`,
        build: `wp-content/themes/${process.env.THEME_NAME}/css/src/`
    },
    css: {
        src: `wp-content/themes/${process.env.THEME_NAME}/css/src/**/*.css`,
        build: `wp-content/themes/${process.env.THEME_NAME}/css/build/`
    }
};
