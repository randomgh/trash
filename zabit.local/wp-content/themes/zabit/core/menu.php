...
function menu_after_setup_theme(){
	register_nav_menus(array(
		'main' => __('Main menu', 'zabit'),
		'language' => __('Languages menu', 'zabit'),
		'social' => __('Social menu', 'zabit'),
		'partners' => __('Partners menu', 'zabit')
	));
}
...
function menu_update_nav_menu_item($menu_id = 0, $menu_item_db_id = 0, $menu_item_data = array()){
	...
	foreach(array('zabit-menu-item-icon') as $i => $input_var){
