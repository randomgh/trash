...
class EditNavMenuWalker extends Walker_Nav_Menu_Edit {

	// TODO: Use parent::start_el
		...
		<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-icon description description-wide">
                <label for="edit-menu-item-icon-<?php echo $item_id; ?>">
					<?php _e( 'Icon' ); ?>
                    <br />
                    <div class="zabit-field zabit-field_media <?php echo $attachment ? 'zabit-field_value' : 'zabit-field_empty'; ?>">
						<?php printf('<input %s />', implode(' ', array_filter(array(
							sprintf('%s="%s"', 'class', 'zabit-field__input edit-menu-item-icon'),
							sprintf('%s="edit-zabit-menu-item-icon-%s"', 'id', $item_id),
							sprintf('%s="zabit-menu-item-icon[%s]"', 'name', $item_id),
							sprintf('%s="%s"', 'type', 'hidden'),
							sprintf('%s="%s"', 'value', esc_attr($icon))
						)))); ?>
                        <span class="zabit-field__value">
                            <img class="zabit-field__value__img" src="<?php echo $attachment ? $attachment['src'] : ''; ?>" alt="item <?php echo $item_id; ?> icon" />
                        </span>
                        ...
                        <span class="description zabit-field__description"><?php _e('The icon will be displayed in the menu if the current theme supports it.', 'zabit'); ?></span>
                    </div>
                </label>
            </p>
